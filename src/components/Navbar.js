...
const Navbar=(props)=>{
  ...
  const handleSearch=(e)=>{
    console.log(search)
    props.setRough(search);
  
    e.preventDefault(); //stops reloading of pages when submit button is triggered
  }
  ...
  <div className="container-fluid">
    ...
    <a class="navbar-brand" href="/#">
      <img src="/brand.png" alt="Logo" width="60" height="50" class="d-inline-block align-text-top"/>
    </a>
